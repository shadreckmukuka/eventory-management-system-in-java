...
jPanel1Layout.createSequentialGroup()
 ...
 add_cmd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/ok1.png"))); // 
NOI18N
 add_cmd.setText("ok");
...
NOI18N
 ...
 delete_cmd.setIcon(new 
javax.swing.ImageIcon(getClass().getResource("/image/b_drop.png"))); // NOI18N
...
Devices(Name,MAC_address,Static_IP,Port_Number,Description)values(?,?,?,?,?)";
 ...
 JOptionPane.showMessageDialog(this, "Please First select device to be deleted from the list 
...
'" + value3 + "', Static_IP = '" + value4 + "',Port_Number= '" + value5 + "',Description ='" +value6+"' where 
Id= '" + value1 + "' ";
 pst = conn.prepareStatement(sql);
 pst.execute();
